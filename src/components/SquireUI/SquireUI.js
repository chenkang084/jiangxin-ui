...
export default class SquireUI extends React.Component {
  ...
  componentDidUpdate(preProps, preState) {
    ...
    if (this.props.showSourceCode) {
      ...
      //   }
      // } else {
      //   this.setState({ html: preProps.sourceCode }, () => {
      //     hljs.highlightBlock(el);
      //   });
      // }
    }
  ...
  handleTextChange = (e) => {
    if (e.currentTarget.value) {
      this.updateSourcecode = true;
      // this.setState({
      //   html: e.currentTarget.value,
      // });
      this.props.updateArticleBySourcecode(e.currentTarget.value);
    }
  };
